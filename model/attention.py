...
if __name__ == "__main__":
    ...
    test_1 = torch.randn(1,64, 22, 22)
    S = ChannelGate(gate_channels=64)
    print("B", S(test_1).size())

    test_2 = torch.randn(1, 32, 1539, 214, 2)
    D = CCBAM(gate_channels=32, no_spatial=True)
    print("D", D(test_2).size())